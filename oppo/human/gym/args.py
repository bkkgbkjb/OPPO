...
parser.add_argument('--dataset', type=str, default='mh')  # medium, medium-replay, medium-expert, expert
parser.add_argument('--mode', type=str, default='normal')  # normal for standard setting, delayed for sparse
parser.add_argument('--K', type=int, default=100)
parser.add_argument('--pct_traj', type=float, default=1.)
parser.add_argument('--batch_size', type=int, default=64)
parser.add_argument('--model_type', type=str, default='pdt')  # dt for decision transformer, bc for behavior cloning
...
parser.add_argument('--robosuite_dataset_path', type=str, default='./robosuite_dataset')
...
parser.add_argument('--pref_loss_ratio', type=float, default=10)
parser.add_argument('--w_lr', type=float, default=1e-2)
